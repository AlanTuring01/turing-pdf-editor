...
const STRINGS = {
  en: {
    ...
    'ocr.pill': 'Recognize text (OCR)',
    'ocr.pillEmpty': 'No text found on this page',
    'ocr.title': 'Recognize text in this scan',
    'ocr.body': 'This looks like a scanned page — the text is pixels, not characters. OCR runs entirely on this device: nothing is uploaded, the engine and models (≈10 MB) load once from the app\u2019s own files. Choose the language:',
    'ocr.en': 'English',
    'ocr.zhen': '中文 + English',
    'ocr.loading': 'Loading OCR engine…',
    'ocr.running': 'Recognizing… {p}%',
    'ocr.done': 'Text recognized — click any line to edit it.',
    'ocr.fail': 'Could not recognize text on this page.',
    'toast.placeSign': 'Click on the page to place your signature.',
    'toast.placeImage': 'Click on the page to place the image — you can also paste (⌘V) or drop images anytime.',
    'toast.imgFail': 'Could not load this image — PNG, JPG or WebP please.',
    'toast.imgNoPage': 'The page is still rendering — try again in a second.',
  ...
  zh: {
    ...
    'ocr.pill': '识别文字 (OCR)',
    'ocr.pillEmpty': '这一页没有识别到文字',
    'ocr.title': '识别扫描件中的文字',
    'ocr.body': '这看起来是扫描页 — 文字只是像素，不是字符。OCR 完全在本机运行：不上传任何内容，识别引擎和模型（约 10 MB）首次使用时从应用自身文件加载。选择语言：',
    'ocr.en': 'English',
    'ocr.zhen': '中文 + English',
    'ocr.loading': '正在加载识别引擎…',
    'ocr.running': '识别中… {p}%',
    'ocr.done': '识别完成 — 点击任意一行即可编辑。',
    'ocr.fail': '这一页没能识别出文字。',
    'toast.placeSign': '点击页面放置签名。',
    'toast.placeImage': '点击页面放置图片 — 平时也可以直接粘贴 (⌘V) 或把图拖进来。',
    'toast.imgFail': '这张图片无法加载 — 请用 PNG、JPG 或 WebP。',
    'toast.imgNoPage': '页面还在渲染，稍等一下再试。',
